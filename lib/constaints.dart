...
const List<Map> rainSounds = [
  {"id": 0, "name": "Soft Rain", "location": "assets/sounds/rain/rain.mp3", "image": "assets/images/sample.jpg"},
  {"id": 1, "name": "Rain and Thunder", "location": "assets/sounds/rain/rain-and-thunder.mp3", "image": "assets/images/sample.jpg"},
  {"id": 2, "name": "Rain at Rainforest", "location": "assets/sounds/rain/rain-at-rainforest.mp3", "image": "assets/images/sample.jpg"},
  {"id": 3, "name": "Rain Drops", "location": "assets/sounds/rain/rain-drops.mp3", "image": "assets/images/sample.jpg"},
  {"id": 4, "name": "Thunder", "location": "assets/sounds/rain/thunder.mp3", "image": "assets/images/sample.jpg"},
];

const List<Map> waterSounds = [
  {"id": 0, "name": "Calm Waves", "location": "assets/sounds/water/calm-waves.mp3", "image": "assets/images/sample.jpg"},
  {"id": 1, "name": "Ocean Waves", "location": "assets/sounds/water/ocean-waves.mp3", "image": "assets/images/sample.jpg"},
  {"id": 2, "name": "River With Whirls", "location": "assets/sounds/water/river-with-whirls.mp3", "image": "assets/images/sample.jpg"},
  {"id": 3, "name": "Stream at Forest", "location": "assets/sounds/water/stream-at-forest.mp3", "image": "assets/images/sample.jpg"},
  {"id": 4, "name": "Water Trickling", "location": "assets/sounds/water/water-trickling.mp3", "image": "assets/images/sample.jpg"},
  {"id": 5, "name": "Beach Waves", "location": "assets/sounds/water/beach-waves.mp3", "image": "assets/images/sample.jpg"},
];

const List<Map> forestSounds = [
  {"id": 0, "name": "Crickets", "location": "assets/sounds/forest/crickets.mp3", "image": "assets/images/sample.jpg"},
  {"id": 1, "name": "Heavy Crickets", "location": "assets/sounds/forest/heavy-crickets.mp3", "image": "assets/images/sample.jpg"},
];

const List<Map> fireSounds = [
  {"id": 0, "name": "Fireplace", "location": "assets/sounds/fire/fireplace.mp3", "image": "assets/images/sample.jpg"},
  {"id": 1, "name": "Fire crackles", "location": "assets/sounds/fire/fire-crackles.mp3", "image": "assets/images/sample.jpg"},
];

const List<Map> birdSounds = [
  {"id": 0, "name": "Birds Singing", "location": "assets/sounds/birds/birds-singing.mp3", "image": "assets/images/sample.jpg"},
  {"id": 1, "name": "Frogs and Birds", "location": "assets/sounds/birds/frogs-and-birds.mp3", "image": "assets/images/sample.jpg"},
  {"id": 2, "name": "Nightingale", "location": "assets/sounds/birds/nightingale.mp3", "image": "assets/images/sample.jpg"},
  {"id": 3, "name": "Birds in a Forest", "location": "assets/sounds/birds/birds-in-a-forest.mp3", "image": "assets/images/sample.jpg"},
];
